...
const {getOwnPropertySymbols: s, prototype: {hasOwnProperty: a}} = Object, {toStringTag: l} = Symbol, u = {}, c = s;
...
const f = [{symbol: "@@__IMMUTABLE_INDEXED__@@", name: "Indexed", modifier: !0}, {
...
function m(e) {
  try {
    ...
    if (!t.length) return;
    const n = t.find(e => !e.modifier), r = "Map" === n.name && t.find(e => e.modifier && e.prefix),
      i = t.some(e => e.arrayish), o = t.some(e => e.setish);
...
function g(n, i, o) {
  let s, a, l, u, c = t(n);
  n instanceof Map ? (s = `Map(${n.size})`, a = b) : n instanceof Set ? (s = `Set(${n.size})`, a = v) : c ? (s = `${n.constructor.name}(${n.length})`, a = w) : (u = m(n)) ? (s = `Immutable.${u.name}${"Record" === u.name ? "" : `(${n.size})`}`, c = u.arrayish, a = u.arrayish ? y : u.setish ? _ : k) : (s = h(n), a = x);
  const d = document.createElement("span");
  d.className = "observablehq--expanded", o && d.appendChild(r(o));
  const p = d.appendChild(document.createElement("a"));
  p.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M4 7L0 1h8z' fill='currentColor' />\n  </svg>", p.appendChild(document.createTextNode(`${s}${c ? " [" : " {"}`)), p.addEventListener("mouseup", function (e) {
  ...
  if (!l.done) {
    ...
    t.className = "observablehq--field", t.style.display = "block", t.appendChild(document.createTextNode("  … more")), t.addEventListener("mouseup", function (t) {
      t.stopPropagation(), d.insertBefore(l.value, d.lastChild.previousSibling);
      for (let e = 0; !(l = a.next()).done && e < 19; ++e) d.insertBefore(l.value, d.lastChild.previousSibling);
...
function* w(e) {
  for (let t = 0, n = e.length; t < n; ++t) t in e && (yield C(t, p(e, t), "observablehq--index"));
  for (const t in e) !n(t) && d(e, t) && (yield C(t, p(e, t), "observablehq--key"));
...
function C(e, t, n) {
  const r = document.createElement("div"), i = r.appendChild(document.createElement("span"));
  return r.className = "observablehq--field", i.className = n, i.textContent = `  ${e}`, r.appendChild(document.createTextNode(": ")), r.appendChild(te(t)), r
}

function E(e, t) {
  const n = document.createElement("div");
  return n.className = "observablehq--field", n.appendChild(document.createTextNode("  ")), n.appendChild(te(e)), n.appendChild(document.createTextNode(" => ")), n.appendChild(te(t)), n
}

function S(e) {
  const t = document.createElement("div");
  return t.className = "observablehq--field", t.appendChild(document.createTextNode("  ")), t.appendChild(te(e)), t
}
...
function N(e, n, i) {
  let o, s, a, l, u = t(e);
  if (e instanceof Map ? (o = `Map(${e.size})`, s = L) : e instanceof Set ? (o = `Set(${e.size})`, s = q) : u ? (o = `${e.constructor.name}(${e.length})`, s = M) : (l = m(e)) ? (o = `Immutable.${l.name}${"Record" === l.name ? "" : `(${e.size})`}`, u = l.arrayish, s = l.arrayish ? A : l.setish ? P : T) : (o = h(e), s = j), n) {
    const t = document.createElement("span");
    return t.className = "observablehq--shallow", i && t.appendChild(r(i)), t.appendChild(document.createTextNode(o)), t.addEventListener("mouseup", function (n) {
  ...
  d.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M7 4L1 8V0z' fill='currentColor' />\n  </svg>", d.appendChild(document.createTextNode(`${o}${u ? " [" : " {"}`)), c.addEventListener("mouseup", function (t) {
    $(c) || (t.stopPropagation(), ne(c, g(e, 0, i)))
  }, !0), s = s(e);
  for (let e = 0; !(a = s.next()).done && e < 20; ++e) e > 0 && c.appendChild(document.createTextNode(", ")), c.appendChild(a.value);
  return a.done || c.appendChild(document.createTextNode(", …")), c.appendChild(document.createTextNode(u ? "]" : "}")), c
}
...
function* A(e) {
  let t = -1, n = 0;
  for (const r = e.size; n < r; ++n) n > t + 1 && (yield O(n - t - 1)), yield te(e.get(n), !0), t = n;
  n > t + 1 && (yield O(n - t - 1))
}

function* M(e) {
  let t = -1, r = 0;
  for (const n = e.length; r < n; ++r) r in e && (r > t + 1 && (yield O(r - t - 1)), yield te(p(e, r), !0), t = r);
  r > t + 1 && (yield O(r - t - 1));
  for (const t in e) !n(t) && d(e, t) && (yield U(t, p(e, t), "observablehq--key"));
...
function U(e, t, n) {
  const r = document.createDocumentFragment(), i = r.appendChild(document.createElement("span"));
  return i.className = n, i.textContent = e, r.appendChild(document.createTextNode(": ")), r.appendChild(te(t, !0)), r
}

function R(e, t) {
  const n = document.createDocumentFragment();
  return n.appendChild(te(e, !0)), n.appendChild(document.createTextNode(" => ")), n.appendChild(te(t, !0)), n
}
...
var G = Function.prototype.toString, K = {prefix: "async ƒ"}, Y = {prefix: "async ƒ*"}, J = {prefix: "class"},
  X = {prefix: "ƒ"}, Q = {prefix: "ƒ*"};
  ...
  switch (s) {
    ...
    case"function":
      return function (e, t) {
        ...
        return n === J ? Z(n, "", t) : (r = /^(?:async\s*)?(\w+)\s*=>/.exec(i)) ? Z(n, "(" + r[1] + ")", t) : (r = /^(?:async\s*)?\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(i)) ? Z(n, r[1] ? "(" + r[1].replace(/\s*,\s*/g, ", ") + ")" : "()", t) : (r = /^(?:async\s*)?function(?:\s*\*)?(?:\s*\w+)?\s*\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(i)) ? Z(n, r[1] ? "(" + r[1].replace(/\s*,\s*/g, ", ") + ")" : "()", t) : Z(n, "(…)", t)
      }(e, i);
    case"string":
      return function (e, t, n, i) {
        if (!1 === t) {
          ...
          if (o.length > B && !n) {
            ...
            s.className = "observablehq--string", s.textContent = "`" + H(o.slice(0, B).join("\n"));
            const a = n.appendChild(document.createElement("span")), l = o.length - B;
          ...
          return a.className = `observablehq--string${n ? " observablehq--expanded" : ""}`, a.textContent = "`" + H(e) + "`", s
        }
    ...
    default:
      ...
      if (e instanceof Date) {
        ...
        }(a) ? D(a.getUTCFullYear()) + "-" + z(a.getUTCMonth() + 1, 2) + "-" + z(a.getUTCDate(), 2) : D(a.getFullYear()) + "-" + z(a.getMonth() + 1, 2) + "-" + z(a.getDate(), 2) + "T" + z(a.getHours(), 2) + ":" + z(a.getMinutes(), 2) + (a.getMilliseconds() ? ":" + z(a.getSeconds(), 2) + "." + z(a.getMilliseconds(), 3) : a.getSeconds() ? ":" + z(a.getSeconds(), 2) : "");
        break
      }
      if (e === u) {
...
class ie {
  ...
  fulfilled(t, n) {
    const {_node: r} = this;
    if ((!(t instanceof Element || t instanceof Text) || t.parentNode && t.parentNode !== r) && (t = te(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"), r.classList.remove("observablehq--running", "observablehq--error"), r.firstChild !== t) if (r.firstChild) {
  ...
  rejected(t, n) {
    ...
    o.className = "observablehq--inspect", n && o.appendChild(r(n)), o.appendChild(document.createTextNode((t + "").replace(re, ""))), i.appendChild(o), e(i, "error", {error: t})
  }
}
...
var ue = {
  canvas: function (e, t) {
    ...
    const r = document.createElement("a"), i = r.appendChild(document.createElement("button"));
    ...
    var n, r = e += "", i = r.indexOf(":");
    i >= 0 && "xmlns" !== (r = e.slice(0, i)) && (e = e.slice(i + 1));
    var o = se.hasOwnProperty(r) ? document.createElementNS(se[r], e) : document.createElement(e);
    if (t) for (var s in t) i = (r = s).indexOf(":"), n = t[s], i >= 0 && "xmlns" !== (r = s.slice(0, i)) && (s = s.slice(i + 1)), se.hasOwnProperty(r) ? o.setAttributeNS(se[r], s, n) : o.setAttribute(s, n);
    return o
  }, input: function (e) {
...
var me = {
  disposable: he, filter: function* (e, t) {
...
function ge(e, t) {
  return function (n) {
    var r, i, o, s, a, l, u, c, d = n[0], h = [], p = null, f = -1;
    for (a = 1, l = arguments.length; a < l; ++a) {
      if ((r = arguments[a]) instanceof Node) h[++f] = r, d += "\x3c!--o:" + f + "--\x3e"; else if (Array.isArray(r)) {
...
function _e(e) {
  this.tokens = [], this.tokens.links = {}, this.options = e || Pe.defaults, this.rules = ve.normal, this.options.gfm && (this.options.tables ? this.rules = ve.tables : this.rules = ve.gfm)
}

ve.bullet = /(?:[*+-]|\d+\.)/, ve.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, ve.item = Ee(ve.item, "gm")(/bull/g, ve.bullet)(), ve.list = Ee(ve.list)(/bull/g, ve.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + ve.def.source + ")")(), ve.blockquote = Ee(ve.blockquote)("def", ve.def)(), ve._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", ve.html = Ee(ve.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, ve._tag)(), ve.paragraph = Ee(ve.paragraph)("hr", ve.hr)("heading", ve.heading)("lheading", ve.lheading)("blockquote", ve.blockquote)("tag", "<" + ve._tag)("def", ve.def)(), ve.normal = qe({}, ve), ve.gfm = qe({}, ve.normal, {
  fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
  paragraph: /^/,
  heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
}), ve.gfm.paragraph = Ee(ve.paragraph)("(?!", "(?!" + ve.gfm.fences.source.replace("\\1", "\\2") + "|" + ve.list.source.replace("\\1", "\\3") + "|")(), ve.tables = qe({}, ve.gfm, {
  nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
  table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
}), _e.rules = ve, _e.lex = function (e, t) {
...
function ye(e, t) {
  if (this.options = t || Pe.defaults, this.links = e, this.rules = we.normal, this.renderer = this.options.renderer || new xe, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
  this.options.gfm ? this.options.breaks ? this.rules = we.breaks : this.rules = we.gfm : this.options.pedantic && (this.rules = we.pedantic)
}
...
function ke(e) {
  this.tokens = [], this.token = null, this.options = e || Pe.defaults, this.options.renderer = this.options.renderer || new xe, this.renderer = this.options.renderer, this.renderer.options = this.options
}
...
function Se(e, t) {
  return $e[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? $e[" " + e] = e + "/" : $e[" " + e] = e.replace(/[^\/]*$/, "")), e = $e[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^\/]*)[\s\S]*/, "$1") + t : e + t
}

we._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/, we._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, we.link = Ee(we.link)("inside", we._inside)("href", we._href)(), we.reflink = Ee(we.reflink)("inside", we._inside)(), we.normal = qe({}, we), we.pedantic = qe({}, we.normal, {
...
}), ye.rules = we, ye.output = function (e, t, n) {
  return new ye(t, n).output(e)
}, ye.prototype.output = function (e) {
  for (var t, n, r, i, o = ""; e;) if (i = this.rules.escape.exec(e)) e = e.substring(i[0].length), o += i[1]; else if (i = this.rules.autolink.exec(e)) e = e.substring(i[0].length), "@" === i[2] ? (n = Ce(":" === i[1].charAt(6) ? this.mangle(i[1].substring(7)) : this.mangle(i[1])), r = this.mangle("mailto:") + n) : r = n = Ce(i[1]), o += this.renderer.link(r, null, n); else if (this.inLink || !(i = this.rules.url.exec(e))) {
    if (i = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(i[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(i[0]) && (this.inLink = !1), e = e.substring(i[0].length), o += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : Ce(i[0]) : i[0]; else if (i = this.rules.link.exec(e)) e = e.substring(i[0].length), this.inLink = !0, o += this.outputLink(i, {
      href: i[2],
      title: i[3]
    ...
    } else if (i = this.rules.strong.exec(e)) e = e.substring(i[0].length), o += this.renderer.strong(this.output(i[2] || i[1])); else if (i = this.rules.em.exec(e)) e = e.substring(i[0].length), o += this.renderer.em(this.output(i[2] || i[1])); else if (i = this.rules.code.exec(e)) e = e.substring(i[0].length), o += this.renderer.codespan(Ce(i[2].trim(), !0)); else if (i = this.rules.br.exec(e)) e = e.substring(i[0].length), o += this.renderer.br(); else if (i = this.rules.del.exec(e)) e = e.substring(i[0].length), o += this.renderer.del(this.output(i[1])); else if (i = this.rules.text.exec(e)) e = e.substring(i[0].length), o += this.renderer.text(Ce(this.smartypants(i[0]))); else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
  } else e = e.substring(i[0].length), r = n = Ce(i[1]), o += this.renderer.link(r, null, n);
  return o
}, ye.prototype.outputLink = function (e, t) {
  var n = Ce(t.href), r = t.title ? Ce(t.title) : null;
  return "!" !== e[0].charAt(0) ? this.renderer.link(n, r, this.output(e[1])) : this.renderer.image(n, r, Ce(e[1]))
  ...
  return t ? '<pre><code class="' + this.options.langPrefix + Ce(t, !0) + '">' + (n ? e : Ce(e, !0)) + "\n</code></pre>\n" : "<pre><code>" + (n ? e : Ce(e, !0)) + "\n</code></pre>"
  ...
  this.inline = new ye(e.links, this.options, this.renderer), this.tokens = e.reverse();
...
function Pe(e, t, n) {
  if (n || "function" == typeof t) {
    n || (n = t, t = null);
    var r, i, o = (t = qe({}, Pe.defaults, t || {})).highlight, s = 0;
    try {
      r = _e.lex(e, t)
    } catch (e) {
      return n(e)
    ...
    if (e.message += "\nPlease report this to https://github.com/chjj/marked.", (t || Pe.defaults).silent) return "<p>An error occurred:</p><pre>" + Ce(e.message + "", !0) + "</pre>";
    throw e
  }
}

Le.exec = Le, Pe.options = Pe.setOptions = function (e) {
  ...
  xhtml: !1,
  baseUrl: null
}, Pe.Parser = ke, Pe.parser = ke.parse, Pe.Renderer = xe, Pe.Lexer = _e, Pe.lexer = _e.lex, Pe.InlineLexer = ye, Pe.inlineLexer = ye.output, Pe.parse = Pe;
...
function Me(e) {
  return function () {
    return ge(function (t) {
      ...
      return r.length > 0 && e(Ae + "highlight.min.js").then(function (t) {
        r.forEach(function (n) {
          function r() {
            t.highlightBlock(n), n.parentNode.classList.add("observablehq--md-pre")
          }

          t.getLanguage(n.className) ? r() : e(Ae + "async-languages/index.js").then(r => {
            if (r.has(n.className)) return e(Ae + "async-languages/" + r.get(n.className)).then(e => {
...
function Ue(e, t) {
  var n;
  return (n = Oe.get(e = +e)) ? n.then(oe(t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function (e, t) {
...
const De = new Map, Ie = [], Fe = Ie.map, Be = Ie.some, He = Ie.hasOwnProperty, We = "https://cdn.jsdelivr.net/npm/",
  Ve = /^((?:@[^\/@]+\/)?[^\/@]+)(?:@([^\/]+))?(?:\/(.*))?$/, Ge = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/, Ke = /\.[^\/]*$/,
...
function Xe(e) {
  ...
  let n = De.get(t);
  return n || De.set(t, n = fetch(t).then(e => {
...
const Qe = Ze(async function (e, t) {
  ...
  if (n.path && !Ke.test(n.path) && (n.path += ".js"), n.path && n.version && Ge.test(n.version)) return `${We}${n.name}@${n.version}/${n.path}`;
  const r = await Xe(n);
  return `${We}${r.name}@${r.version}/${n.path || function (e) {
    for (const t of Ye) {
      const n = e[t];
...
function Ze(e) {
  ...
  function r(e) {
    ...
    return n || t.set(e, n = new Promise((t, n) => {
      ...
      }, r.async = !0, r.src = e, window.define = rt, document.head.appendChild(r)
    })), n
  }
  ...
  function o(e) {
    return arguments.length > 1 ? Promise.all(Fe.call(arguments, n)).then(et) : n(e)
  }

  return o.alias = function (t) {
    return Ze((n, r) => n in t && (r = null, "string" != typeof (n = t[n])) ? n : e(n, r))
  }, o.resolve = e, o
}

function et(e) {
  const t = {};
  for (const n of e) for (const e in n) He.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {get: tt(n, e)}) : t[e] = n[e]);
  return t
}
...
function rt(e, t, n) {
  ...
  r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), Ie.push(Be.call(t, nt) ? e => {
    const r = {}, i = {exports: r};
    return Promise.all(Fe.call(t, t => "exports" === (t += "") ? r : "module" === t ? i : e(t))).then(e => (n.apply(null, e), i.exports))
  } : e => Promise.all(Fe.call(t, e)).then(e => "function" == typeof n ? n.apply(null, e) : n))
}
...
function lt(e) {
  return function () {
    return Promise.all([e("@observablehq/katex@0.11.1/dist/katex.min.js"), e.resolve("@observablehq/katex@0.11.1/dist/katex.min.css").then(at)]).then(function (e) {
      var t = e[0], n = r();

      function r(e) {
        return function () {
          var n = document.createElement("div");
          return t.render(st.apply(String, arguments), n, e), n.removeChild(n.firstChild)
        }
      }
...
dt.prototype = Object.create(Error.prototype), dt.prototype.name = "RuntimeError", dt.prototype.constructor = dt;
var ht = Array.prototype, pt = ht.map, ft = ht.forEach;
...
var vt = 1, _t = 2, wt = 3, yt = {};

function xt(e, t, n) {
  var r;
  null == n && (n = yt), Object.defineProperties(this, {
...
function $t(e, t, n) {
  var r = this._module._scope, i = this._module._runtime;
  if (this._inputs.forEach(Ct, this), t.forEach(kt, this), this._inputs = t, this._definition = n, this._value = void 0, n === bt ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) this._outputs.forEach(i._updates.add, i._updates); else {
    var o, s;
    if (this._name) if (this._outputs.size) r.delete(this._name), (s = this._module._resolve(this._name))._outputs = this._outputs, this._outputs = new Set, s._outputs.forEach(function (e) {
      e._inputs[e._inputs.indexOf(this)] = s
    }, this), s._outputs.forEach(i._updates.add, i._updates), i._dirty.add(s).add(this), r.set(this._name, s); else if ((s = r.get(this._name)) === this) r.delete(this._name); else {
    ...
    e && ((s = r.get(e)) ? s._type === wt ? (this._definition = St(e), this._duplicate = n, s._duplicates.add(this)) : s._type === _t ? (this._outputs = s._outputs, s._outputs = new Set, this._outputs.forEach(function (e) {
      e._inputs[e._inputs.indexOf(s)] = this
    }, this), i._dirty.add(s).add(this), r.set(e, this)) : (s._duplicate = s._definition, this._duplicate = n, (o = new xt(wt, this._module))._name = e, o._definition = this._definition = s._definition = St(e), o._outputs = s._outputs, s._outputs = new Set, o._outputs.forEach(function (e) {
...
function Nt(e) {
  Object.defineProperties(this, {_runtime: {value: e}, _scope: {value: new Map}, _source: {value: null, writable: !0}})
}
...
Object.defineProperties(xt.prototype, {
  _pending: {
    ...
    value: function (e, t, n) {
      ...
      return $t.call(this, null == e ? null : e + "", null == t ? [] : pt.call(t, this._module._resolve, this._module), "function" == typeof n ? n : mt(n))
    }, writable: !0, configurable: !0
  }, delete: {
    value: function () {
  ...
  _copy: {
    value: function (e, t) {
      ...
      for (const [o, s]of this._scope) {
        ...
        if (!n || n._type !== vt) if (s._definition === gt) {
          var r = s._inputs[0], i = r._module;
          e.import(r._name, o, t.get(i) || (i._source ? i._copy(new Nt(e._runtime), t) : i))
    ...
    value: function (e) {
      ...
      if (!n) if (n = new xt(_t, this), this._runtime._builtin._scope.has(e)) n.import(e, this._runtime._builtin); else if ("invalidation" === e) n.define(e, Pt); else if ("visibility" === e) n.define(e, At); else {
        try {
        ...
        void 0 === t ? this._scope.set(n._name = e, n) : n.define(e, mt(t))
      }
      var r;
      return n
    }, writable: !0, configurable: !0
    ...
    value: function (e, t) {
      ...
      return n._source = this, ft.call(e, function (e) {
        "object" != typeof e && (e = {name: e + ""}), null == e.alias && (e.alias = e.name), n.import(e.name, e.alias, t)
      }), Promise.resolve().then(() => {
        const e = new Set([this]);
        for (const t of e) for (const n of t._scope.values()) if (n._definition === gt) {
          const t = n._inputs[0]._module, r = t._source || t;
...
const qt = "function" == typeof requestAnimationFrame ? requestAnimationFrame : setImmediate;
var Pt = {}, At = {};

function Mt(e = new ct, t = function (e) {
  return window[e]
}) {
  var n = this.module();
  if (Object.defineProperties(this, {
    ...
    _builtin: {value: n},
    _global: {value: t}
  }), e) for (var r in e) new xt(_t, n).define(r, [], e[r])
}
...
function zt(e, t) {
  let n, r, i = "function" == typeof IntersectionObserver && t._observer && t._observer._node, o = !i, s = bt, a = bt;
  return i && ((r = new IntersectionObserver(([e]) => (o = e.isIntersecting) && (n = null, s()))).observe(i), e.then(() => (r.disconnect(), r = null, a()))), function (e) {
...
function Dt(e) {
  ...
  var t = e._value, n = ++e._version, r = null, i = e._promise = Promise.all(e._inputs.map(Ut)).then(function (i) {
    if (e._version === n) {
      ...
      function i() {
        var n = new Promise(function (e) {
          ...
          return r.done ? void 0 : Promise.resolve(r.value).then(function (r) {
            if (e._version === t) return It(e, r, n).then(i), e._fulfilled(r), r
          })
        });
        n.catch(function (r) {
...
function Ft(e, t) {
  e._invalidate(), e._invalidate = bt, e._pending(), ++e._version, e._indegree = NaN, (e._promise = Promise.reject(t)).catch(bt), e._value = void 0, e._rejected(t)
}
...
Object.defineProperties(Mt, {
  load: {
    value: function (e, t, n) {
      ...
      null == t && (t = new ct);
      const {modules: r, id: i} = e, o = new Map, s = new Mt(t), a = l(i);
  ...
  _compute: {
    ...
    value: function () {
      ...
      do {
        ...
        }); t = n.pop();) Dt(t), t._outputs.forEach(r), e.delete(t);
        e.forEach(function (t) {
          jt(t) && (Ft(t, new dt("circular definition")), t._outputs.forEach(Ot), e.delete(t))
        })
      } while (e.size);
    ...
    value: function (e, t = bt) {
      let n;
      if (void 0 === e) return (n = this._init) ? (this._init = null, n) : new Nt(this);
